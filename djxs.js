...
!(async () => {
    if (typeof $request !== "undefined") {
        console.log('没有重写，自己捉包去')
    } else {
        console.log('跑一次3000金币，自己定时，多账户用@隔开')
...
function video(uIdx,idx,p1) {
    return new Promise((resolve) => {
        ...
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E149",
